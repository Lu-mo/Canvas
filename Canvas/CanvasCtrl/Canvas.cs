...
namespace Canvas
{
	...
	public partial class CanvasCtrl : UserControl
	{
		...
		SelectionRectangle	m_selection = null;//被选中的弧
		...
		protected  void SetCenterScreen(PointF screenPoint, bool setCursor)//图像居中
        {
		...
		void RepaintStatic(Rectangle r)
		{
            ...
            //r.X = m_staticImage.Width;r.Y = m_staticImage.Height;
            ...
            //MessageBox.Show(m_staticImage.Size.ToString());
            dc.Dispose();
		}
		...
		protected virtual void HandleMouseDownWhenDrawing(UnitPoint mouseunitpoint, ISnapPoint snappoint)
		{
			if (m_commandType == eCommandType.draw)
			{
				if (m_newObject == null)
				{
                    //Console.WriteLine("m_newObject == null");
